...
#define DENZIC_AUDIO_V1_LEVELING_SCALE_ONE_PERMILLE (1000u)
#define DENZIC_AUDIO_V1_LEVELING_INITIAL_NOISE_FLOOR_MEAN_ABS (4u)
#define DENZIC_AUDIO_V1_LEVELING_MINIMUM_NOISE_FLOOR_MEAN_ABS (1u)
#define DENZIC_AUDIO_V1_LEVELING_NOISE_RISE_TIME_MS (3200u)
#define DENZIC_AUDIO_V1_LEVELING_NOISE_FALL_TIME_MS (800u)
#define DENZIC_AUDIO_V1_LEVELING_SPEECH_HOLD_MS (300u)
#define DENZIC_AUDIO_V1_LEVELING_ATTENUATION_ATTACK_MS (80u)
#define DENZIC_AUDIO_V1_LEVELING_ATTENUATION_RELEASE_MS (40u)
#define DENZIC_AUDIO_V1_LEVELING_MAXIMUM_EFFECTIVE_GAIN_PERMILLE (24000u)
#define DENZIC_AUDIO_V1_LEVELING_MAXIMUM_NOISE_OUTPUT_MEAN_ABS (64u)
