...
impl PacketType {
    pub const fn wire_value(self) -> u8 {
        match self {
            Self::SessionStart => generated::PACKET_TYPE_SESSION_START,
            Self::AudioData => generated::PACKET_TYPE_AUDIO_DATA,
            Self::SessionStop => generated::PACKET_TYPE_SESSION_STOP,
            Self::SessionCancel => generated::PACKET_TYPE_SESSION_CANCEL,
            Self::SessionError => generated::PACKET_TYPE_SESSION_ERROR,
        }
    }
}
...
impl TryFrom<u8> for PacketType {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            value if value == generated::PACKET_TYPE_SESSION_START => Ok(Self::SessionStart),
            value if value == generated::PACKET_TYPE_AUDIO_DATA => Ok(Self::AudioData),
            value if value == generated::PACKET_TYPE_SESSION_STOP => Ok(Self::SessionStop),
            value if value == generated::PACKET_TYPE_SESSION_CANCEL => Ok(Self::SessionCancel),
            value if value == generated::PACKET_TYPE_SESSION_ERROR => Ok(Self::SessionError),
...
impl SessionErrorCode {
    pub const fn from_wire(value: u16) -> Self {
        match value {
            value if value == generated::SESSION_ERROR_NONE => Self::None,
            value if value == generated::SESSION_ERROR_QUEUE_FULL => Self::QueueFull,
            value if value == generated::SESSION_ERROR_NOTIFY_TIMEOUT => Self::NotifyTimeout,
            value if value == generated::SESSION_ERROR_LINK_LOST => Self::LinkLost,
            value if value == generated::SESSION_ERROR_SEQUENCE_OVERFLOW => Self::SequenceOverflow,
            value if value == generated::SESSION_ERROR_INVALID_STATE => Self::InvalidState,
            value if value == generated::SESSION_ERROR_NO_MEMORY => Self::NoMemory,
            value if value == generated::SESSION_ERROR_PACKET_TOO_LARGE => Self::PacketTooLarge,
            value if value == generated::SESSION_ERROR_TRANSPORT => Self::Transport,
    ...
    pub const fn wire_value(self) -> u16 {
        match self {
            Self::None => generated::SESSION_ERROR_NONE,
            Self::QueueFull => generated::SESSION_ERROR_QUEUE_FULL,
            Self::NotifyTimeout => generated::SESSION_ERROR_NOTIFY_TIMEOUT,
            Self::LinkLost => generated::SESSION_ERROR_LINK_LOST,
            Self::SequenceOverflow => generated::SESSION_ERROR_SEQUENCE_OVERFLOW,
            Self::InvalidState => generated::SESSION_ERROR_INVALID_STATE,
            Self::NoMemory => generated::SESSION_ERROR_NO_MEMORY,
            Self::PacketTooLarge => generated::SESSION_ERROR_PACKET_TOO_LARGE,
            Self::Transport => generated::SESSION_ERROR_TRANSPORT,
